    ...
    <Layout onLogout={onLogout} onNavigate={onNavigate} currentPage={currentPage}>
      <div className="flex-1 p-3 md:p-6 space-y-4 md:space-y-6">
        ...
        {loading && (
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-medium transition-colors duration-300 text-blue-700">
        ...
        {/* Import Messages */}
        {importError && (
          <div className="mb-6 border px-4 py-3 rounded-lg relative transition-all duration-300 bg-red-50 border-red-200 text-red-800">
        ...
        {importSuccess && (
          <div className="mb-6 border px-4 py-3 rounded-lg relative transition-all duration-300 bg-green-50 border-green-200 text-green-800">
            <div className="flex items-center gap-2">
                ...
                <thead>
                  <tr className="border-b transition-all duration-300 border-gray-200 bg-gray-50">
                    ...
                    <th className="px-6 py-4 text-left text-xs font-semibold uppercase tracking-wider transition-colors duration-300 text-gray-700">
                      ...
                      <>
                        <th className="px-6 py-4 text-center text-xs font-semibold uppercase tracking-wider transition-all duration-300 text-gray-700">
                          Months
                        </th>
                        <th className="px-6 py-4 text-center text-xs font-semibold uppercase tracking-wider transition-all duration-300 text-gray-700">
                          Total Patrols
                ...
                <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                  {Object.keys(groupedData).map((district) => (
                    <React.Fragment key={district}>
                      ...
                      <span className="text-sm transition-colors duration-300 text-gray-700">
      ...
      {showClearModal && (
        <div className="fixed inset-0 bg-transparent flex items-center justify-center z-50">
          <div
            className="rounded-xl p-6 w-96 max-w-md mx-4 shadow-2xl border transition-all duration-300 bg-white/95 border-gray-200/50"
          >
            <div className="flex items-center justify-between mb-4">
              <h3
                className="text-lg font-semibold transition-colors duration-300 text-gray-900"
              >
                Clear Patrol Data
              </h3>
              <button
                onClick={() => setShowClearModal(false)}
                className="p-1 rounded-full transition-colors duration-300 text-gray-500 hover:text-gray-700 hover:bg-gray-100/80"
              >
                <XCircle className="w-5 h-5" />
              </button>
            </div>
            <p
              className="text-sm mb-6 transition-colors duration-300 text-gray-600"
            >
              Choose what you want to clear ? </p>
            <div className="space-y-3">
              <button
                onClick={() => clearPatrolData(false)}
                disabled={clearLoading}
                className={`w-full p-4 rounded-lg border-2 transition-all duration-300 border-orange-300 text-orange-700 hover:bg-orange-50 hover:border-orange-400 ${
              ...
              <button
                ...
                disabled={clearLoading}
                className={`w-full p-4 rounded-lg border-2 transition-all duration-300 border-red-300 text-red-700 hover:bg-red-50 hover:border-red-400 ${
                  clearLoading ? "opacity-50 cursor-not-allowed" : "hover:scale-105 hover:shadow-md"
                }`}
              >
                <div className="flex items-center justify-between">
            ...
            <div className="mt-6 flex justify-end">
              <button
                onClick={() => setShowClearModal(false)}
                disabled={clearLoading}
                className="px-4 py-2 rounded-md text-sm font-medium transition-colors duration-300 bg-gray-200/80 text-gray-700 hover:bg-gray-300/80"
              >
                Cancel
              </button>
            </div>
      ...
      {showSummaryReport && (
        <div className="fixed inset-0 bg-transparent flex items-center justify-center z-50">
          <div
            className="rounded-xl p-6 w-[800px] max-w-[90vw] mx-4 shadow-2xl border transition-all duration-300 bg-white/95 border-gray-200/50"
          >
            <div className="flex items-center justify-between mb-4">
              <h3
                className="text-lg font-semibold transition-colors duration-300 text-gray-900"
                        ...
                        <div className="space-y-2 text-sm">
                          <div className="flex justify-between">
                            ...
                            <span className="font-semibold text-blue-600 dark:text-blue-400">
                              {(summary?.totalPatrols || 0).toLocaleString()}
                            </span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">
                            ...
                            <span className="font-semibold text-green-600 dark:text-green-400">
                              {(summary?.totalActive || 0).toLocaleString()}
                            </span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">
                            ...
                            <span className="font-semibold text-red-600 dark:text-red-400">
                              {(summary?.totalInactive || 0).toLocaleString()}
                            </span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">
      ...
      {showPhotoModal && selectedItemForPhotos && (
        <div className="fixed inset-0 bg-transparent flex items-center justify-center z-50">
          <div
            className="rounded-xl p-6 w-full max-w-2xl mx-4 shadow-2xl border transition-all duration-300 bg-white/95 border-gray-200/50"
          >
                      ...
                      <div className="mb-6">
                        <label
                          htmlFor="photo-date"
                          className="block text-sm font-medium mb-2 transition-colors duration-300 text-gray-700"
                        >
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 border rounded-md text-sm transition-all duration-300 bg-white border-gray-300 text-gray-900 focus:border-blue-500 focus:ring-blue-500 focus:outline-none focus:ring-2 focus:ring-opacity-50"
                        />
                      </div>
                      {/* Action Taken */}
                      <div className="mb-6">
                        ...
                        <textarea
                          ...
                          rows={3}
                          className="w-full px-3 py-2 border rounded-md text-sm transition-all duration-300 resize-none bg-white border-gray-300 text-gray-900 focus:border-blue-500 focus:ring-blue-500 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-opacity-50"
                        />
                      </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Before Photo Section */}
              <div className="space-y-4">
                <h4 className="text-lg font-semibold transition-colors duration-300 text-gray-900">
                  Before Photo
                </h4>
                <div className="border-2 border-dashed rounded-lg p-6 text-center transition-colors duration-300 border-gray-300 bg-gray-50">
                  {beforePhoto ? (
                    <div className="space-y-3">
                      <img 
                        src={beforePhoto} 
      ...
      {showViewReportModal && selectedItemForView && (
        <div className="fixed inset-0 bg-transparent flex items-center justify-center z-50">
          <div
            className="rounded-xl p-6 w-full max-w-4xl mx-4 shadow-2xl border transition-all duration-300 bg-white/95 border-gray-200/50"
          >
            <div className="flex items-center justify-between mb-6">
              <div>
                <h3
                  className="text-2xl font-bold transition-colors duration-300 text-gray-900"
                >
            ...
            {/* Report Summary */}
            <div className="p-4 rounded-lg border mb-6 bg-gray-50 border-gray-200">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                ...
                <div>
                  <span className="text-gray-600">Inactive Days:</span>
            ...
            <div className="space-y-6">
              ...
              <div className="border rounded-lg p-4 max-h-96 overflow-y-auto border-gray-200 bg-gray-50">
                ...
                <div className="space-y-6">
                  ...
                  {Array.from({ length: 31 }, (_, index) => {
                    ...
                    return (
                      <div key={day} className="p-6 rounded-lg border transition-all duration-300 border-gray-200 bg-white hover:bg-gray-50">
                        <div className="mb-2">
                          <h6 className="font-medium text-sm transition-colors duration-300 text-gray-700">
                            📅 August {day}, 2025
                          ...
                          <div className="space-y-1">
                            <span className="text-xs font-medium transition-colors duration-300 text-gray-600">
                              Before Photo
                            </span>
                                                         <div className="border rounded-lg p-2 text-center border-gray-200 bg-gray-100">
                               {(() => {
                           ...
                           if (photoData?.actionTaken) {
                             return (
                               <div className="mt-3">
                                 ...
                                 <div className="mt-1 p-2 rounded border text-xs transition-colors duration-300 border-gray-200 bg-gray-100 text-gray-700">
